...
ShelterOfferNoPress: =>
  ...
  option "You don't think you can shoulder the risk of trusting someone you met less than an hour ago. Tell Logan that you're not interested in joining him here.": => await scene @ShelterOfferNoPressDecline
  await do choice
