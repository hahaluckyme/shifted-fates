...
Enter: =>
    ...
    if CrystalSpectrograph.player_made_plan and not CrystalSpectrograph.has_tongs
        say paragraph "Recalling the spectrograph in the research lab, you may be able to find a pair of tongs around here to transport one of the glowing crystals without coming into direct contact with it."
...
Tongs: =>
    CrystalSpectrograph.has_tongs = true
    say paragraph "A"