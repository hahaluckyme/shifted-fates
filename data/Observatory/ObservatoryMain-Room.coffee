...
Enter: =>
  if not @discovered
    ...
    say paragraph "The room you woke up in feels eerie to return to. The equipment doesn't seem to have been touched since you were last here, and the floor is still covered in glass from when you shattered the containment pod's pane. It's hard not to admire the gigantic terrestrial telescope standing unfazed amidst the chaos."
