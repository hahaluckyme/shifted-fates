...
Log: =>
    if not CrystalSpectrometer.player_understands_device
        ...
        say paragraph "You found out that the instrument in the research lab is a spectrometer. By making use of it, you may be able to learn more about the strange, glowing crystals in the room you woke up in."
    else
